...
class PersonAdapter : RecyclerView.Adapter<PersonAdapter.viewHolder>(), OnPersonItemclickListner{

    var items = ArrayList<Person>()
    lateinit var listner: OnPersonItemclickListner

    override fun onItemClick(holder: viewHolder, view: View, position: Int) {
        listner?.let { listner.onItemClick(holder, view, position) }
    }

    fun setOnItemClickListner(listner : OnPersonItemclickListner){
    ...
    inner class viewHolder : RecyclerView.ViewHolder {
        constructor(itemView: View, listner : OnPersonItemclickListner) : super(itemView) {
            ...
            itemView.setOnClickListener (object : View.OnClickListener{
                override fun onClick(p0: View?) {
                    ...
                    listner?. let { listner.onItemClick(this@viewHolder,  itemView, position) }
                }
            })
        }
